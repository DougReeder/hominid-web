...
<html>
	<head>
		...
		<title>Outline Tracker F.A.Q.</title>
	</head>
	<body id='faq'>
		<div id='outer'>
			...
			<div id='main'>
				<div id='content'>
					<p>Estas preguntas frecuentes también están disponibles (¡y con búsqueda automática por palabras clave!) en la aplicación — en la escena <strong>Ayuda</strong>,
					pulse <strong>FAQ con busqueda</strong>.</p>
					<noscript>Enable JavaScript to see the FAQs.</noscript>
					<!--
						<dl id='faq'><dt class='faq question'></dt><dd class=''>definition
						body</dd></dl>
					-->
					<div id='container'>
						<div class='faqs'>
